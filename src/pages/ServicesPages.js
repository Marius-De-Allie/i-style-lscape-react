...
import { IoIosArrowUp, IoIosArrowDropdown } from 'react-icons/io';
    ...
    <div className="main-serv-container">
      ...
      <div className="service-cards-container">
            <div className="service-card">
              ...
              {false && <p className="card-txt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam fringilla diam mi, vel tempus ligula congue non. Morbi vitae tincidunt.</p>}
            </div>
            <div className="service-card">
              <div className="card-heading-container">
